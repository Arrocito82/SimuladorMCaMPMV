...
public class MemoriaPrincipal : MonoBehaviour
{
    ...
    private List<Tuple<int,int,int,int>> gestionEmplazamientoLRU;//marco, uso, indice primer bloque, index posici�n primer bloque del marco
    ...
    public void Awake()
    {
        ...
        for (int i=0x0; i< maximoDireccionableMP; i++)
        {
            ...
            contadorPalabra++;
            // set contadores direcci�n memoria cach�
            ...
            // set contadores direcci�n memoria virtual
    ...
    /**
     * Este m�todo tiene por proposito calcular en que indice inicia el bloque que buscan.
     ...
     * sino 
     * entonces hay que ir a buscar el marco completo (p�gina) a la memoria virtual
     * calcular en que posici�n se colocar� dependiendo del indice de uso
    ...
    */
    ...
    private void addMarco(int marco, int indicePrimerBloque, int posicionInicialMarco)
    {
        ...
        // agregando el marco existente a la posici�n inicial
        this.gestionEmplazamientoLRU.Insert(0, new Tuple<int, int,int,int>(marco, uso,indicePrimerBloque,posicionInicialMarco));
    }
    // pone el marco en la posici�n inicial con uso = 1, e incrementa los usos de los dem�s marcos
    ...
    //retorna si existe o no y si existe te dice la posici�n actual
    ...
    {
        int  posicionInicialMarco= 0;
        // verificando el tama�o de la lista de usos, debe ser menor a 8
        // cual es el bloque m�s viejo?
        for (int i = 0; i < 8; i++)
        {
            ...
            //Debug.Log($"Marco {currentMarco.Item1}");
                ...
                {
                    //marco no asignado, esta es la �ltima posici�n
